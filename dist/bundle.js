...
var _EmployeeCreate = __webpack_require__(104);
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            _axios2.default.get('/api/employees').then(function (result) {
                ...
                var managerMap = employees.reduce(function (memo, employee) {
                    if (employee.manager) {
                        memo[employee.manager.id] = employee.manager;
                    }
                    return memo;
                }, {});
                var managers = Object.keys(managerMap).map(function (key) {
                    return managerMap[key];
                });
                _this2.setState({ managers: managers, employees: employees });
            });
        }
    }, {
        key: 'onCreate',
        value: function onCreate(employee) {
            var _this3 = this;

            _axios2.default.post('/api/employees', employee).then(function (result) {
                return result.data;
            }).then(function (employee) {
                var employees = [].concat(_toConsumableArray(_this3.state.employees), [employee]);
                _this3.setState({ employees: employees });
            });
        }
    }, {
        key: 'render',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouterDom.Route, { render: function render(_ref) {
                            ...
                            return _react2.default.createElement(_Nav2.default, { employeeCount: employees.length, managerCount: managers.length, managers: managers, employees: employees, path: location.pathname });
                        } }),
                    ...
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/employees/create', exact: true, render: function render() {
                            return _react2.default.createElement(_EmployeeCreate2.default, { employees: employees, onCreate: onCreate });
                        } })
                )
            );
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_StaticRouter__ = __webpack_require__(95);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Switch__ = __webpack_require__(97);
// Written in this round about way for babel-transform-imports
...
var Nav = function Nav(_ref) {
    var employeeCount = _ref.employeeCount,
        managerCount = _ref.managerCount,
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'li',
            null,
            path === '/employees/create' ? _react2.default.createElement(
                'span',
                null,
                'Create an Employee '
            ) : _react2.default.createElement(
...
var EmployeeCreate = function (_Component) {
    ...
    function EmployeeCreate() {
        ...
        var _this = _possibleConstructorReturn(this, (EmployeeCreate.__proto__ || Object.getPrototypeOf(EmployeeCreate)).call(this));
        ...
        _this.onChangeManager = _this.onChangeManager.bind(_this);
    ...
    _createClass(EmployeeCreate, [{
        ...
        key: 'onChangeManager',
        value: function onChangeManager(ev) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'form',
                { onSubmit: onSave },
                _react2.default.createElement('input', { value: name, onChange: onChangeName }),
                _react2.default.createElement(
                    'select',
                    { value: managerId, onChange: onChangeManager },
                    _react2.default.createElement(
                        'option',
                        { value: '' },
                        'none '
